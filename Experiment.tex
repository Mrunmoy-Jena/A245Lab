...
The first step for this experiment is to devise a method to focus the laser beam into the crystal and subsequently collimate the second harmonic wave generated from the crystal. In order to accomplish this, we use a plano-convex lens with a focal length of $f=$60 mm. The lens was placed such that its convex surface faced the incoming beam and the plane surface faced the opposite direction.